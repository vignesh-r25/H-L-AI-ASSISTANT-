        ...
        <ul className="space-y-1">
          ...
          <li>
            <button
              ...
              className="nav-item w-full text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-950/30 group"
            >
              <div className="p-1 rounded bg-blue-100 dark:bg-blue-950/50 group-hover:bg-blue-200 dark:group-hover:bg-blue-900/50 mr-2">
